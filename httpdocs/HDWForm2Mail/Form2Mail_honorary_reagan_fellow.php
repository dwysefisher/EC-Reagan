<?php
  ...
  // ********************************************************************
  // IF YOU WANT TO SEND COPIES TO ANOTHER EMAIL ADDRESS
  // ********************************************************************
  ...
  define('EMAIL_COPY1','info@teamontheground.com');
  define('EMAIL_COPY2','clorimor@eureka.edu');
  ...
  // this fields will not be sent into the email, use field name on the form
  // you can have any number of excluded fields (comma separated and enclosed with ")
  $excluded_fields = array ( "sampleExcludedField" , "otherExcludedField" );
  ...
  function getCountryID($ip)
  {
      ...
      if ($country == 0) $country = getCountryByIp($cip, "2");    
      return $country;    
  }  
  ...
  # Message Body
  $body ="<strong>HONORARY REAGAN FELLOW EVENT SUBMISSION</strong><br />"
        ."<strong>***************************</strong><br />";
